...
- **Sistema de batalha** (turnos, status effects como Poison/Burn/Sleep, cálculo de dano, condições de vitória/derrota): mudanças aqui podem quebrar mecânicas em cascata, então teste manualmente ou rode os testes existentes antes de considerar a tarefa concluída, mesmo que eu não tenha pedido explicitamente.
